...
-- Split window
vim.keymap.set("n", "\\", ":split<CR>", { desc = "SPLIT WINDOW HORIZONTAL", silent = true })
vim.keymap.set("n", "|", ":vsplit<CR>", { desc = "SPLIT WINDOW VERTICAL", silent = true })


-- Move line
vim.keymap.set("i", "<A-j>", "<Esc>:m .+1<CR>==gi", { desc = "MOVE LINE DOWN IN INSERT MODE", silent = true })
vim.keymap.set("i", "<A-k>", "<Esc>:m .-2<CR>==gi", { desc = "MOVE LINE UP IN INSERT MODE", silent = true })


vim.keymap.set("n", "<A-j>", ":m .+1<CR>==", { desc = "MOVE LINE DOWN IN NORMAL MODE", silent = true })
vim.keymap.set("n", "<A-k>", ":m .-2<CR>==", { desc = "MOVE LINE UP IN NORMAL MODE", silent = true })

vim.keymap.set("v", "<A-j>", ":m '>+1<CR>gv-gv", { desc = "MOVE LINE DOWN IN VISUAL MODE", silent = true })
vim.keymap.set("v", "<A-k>", ":m '<-2<CR>gv-gv", { desc = "MOVE LINE UP IN VISUAL MODE", silent = true })
